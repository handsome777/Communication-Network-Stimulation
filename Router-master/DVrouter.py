...
class DVrouter(Router):
        ...
        if dst in self.routersCost:
            if src in self.routersCost:
                if (self.routersCost[dst] > self.routersCost[src] + cost) or (self.routersNext[dst] == src and src != dst):
                    ...
                    return True, dst, self.routersCost[dst]
        '''
        print "routersCost",self.routersCost
        print "routersNext",self.routersNext
        print "routersPort",self.routersPort
        print "routersAddr",self.routersAddr
        '''
    ...
    def debugString(self):
        ...
        if self.temp != self.routersCost:
            print self.routersCost
            #self.temp = self.routersCost
            #print self.temp
        return out
